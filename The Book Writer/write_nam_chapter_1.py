...
async def write_nam_chapter_1():
    """Write Chapter 1 of the NAM book"""
    
    # Initialize the Synthor for NAM book
    synthor = HyperNarrativeSynthor(
        project_name="Non-Anthropocentric Mathematics",
...
The prison doors are open. The vast mathematical wilderness awaits. Let us venture forth with wisdom, humility, and wonder into the liberation of mathematics from human constraints."""
    ...
    await synthor.save_snapshot(
        ...
        description=f"Completed Chapter 1: {synthor.project_state['stats']['word_count']} words"
    )
    ...
    # Print summary
    print(f"\n{'='*60}")
    print(f"NAM BOOK - CHAPTER 1 COMPLETE")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    asyncio.run(write_nam_chapter_1())