...
impl QueryParser {
    ...
    pub async fn parse(&self, query: &str) -> Result<ExecutionPlan, Box<dyn std::error::Error>> {
    ...
    fn generate_sub_queries(
        ...
        intent: &QueryIntent,
        entities: &[Entity],
    ) -> Result<Vec<SubQuery>, Box<dyn std::error::Error>> {
...
impl IntentClassifier {
    ...
    fn classify(&self, query: &str, entities: &[Entity]) -> Result<QueryIntent, Box<dyn std::error::Error>> {
...
impl QueryOptimizer {
    ...
    fn optimize(&self, sub_queries: &[SubQuery], intent: &QueryIntent) -> Result<ExecutionStrategy, Box<dyn std::error::Error>> {
...
impl EntityExtractor {
    ...
    fn extract(&self, query: &str) -> Result<Vec<Entity>, Box<dyn std::error::Error>> {
